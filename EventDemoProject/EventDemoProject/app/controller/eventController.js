...
var eventController = (function () {
    function eventController($scope, eventServices, $rootScope, $location) {
        ...
        this.$scope.getAllEventList = function () {
            return _this.getAllEventList();
        };
        this.$scope.openDatepickerDialog = function ($event) {
            return _this.openDatepickerDialog($event);
        };
        ...
        this.$scope.createNewEvent = function (event, date) {
            return _this.createNewEvent(event, date);
        };
        this.$scope.location = '';
        this.$scope.event = new Model.Event();
        this.$scope.eventButton = false;
        this.$scope.eventCollection = [];
        this.$scope.eventChange = function (status, eventId) {
            return _this.eventChange(status, eventId);
        };
...
app.controller(eventController.controllerId, [
    '$scope', 'eventServices', '$rootScope', '$location', function ($scope, eventServices, $rootScope, $location) {
